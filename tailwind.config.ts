  ...
  theme: {
    extend: {
      colors: {
        ...
        cream: 'rgb(var(--color-text-primary) / <alpha-value>)', // primary text
        beige: 'rgb(var(--color-text-secondary) / <alpha-value>)', // secondary text
        dust: 'rgb(var(--color-text-muted) / <alpha-value>)', // muted text
        gold: 'rgb(var(--color-accent) / <alpha-value>)', // black accent
        'gold-hover': 'rgb(var(--color-accent-bright) / <alpha-value>)', // neutral hover
        'btn-dark': 'rgb(var(--color-btn-dark-text) / <alpha-value>)', // inverse button text
        line: 'rgb(var(--color-border) / <alpha-value>)', // neutral borders/dividers
      },
      fontFamily: {
