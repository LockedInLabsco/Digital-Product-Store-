        ...
        <section className="py-12 sm:py-16">
          <Container>
            ...
            <div className="max-w-3xl">
              <h1 className="font-sans font-bold tracking-tight text-5xl sm:text-6xl mb-4 leading-tight text-cream">Privacy Policy</h1>
        ...
        <section className="py-16 sm:py-20 border-t border-line">
          <Container>
            <div className="max-w-3xl legal-copy">
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">What Information We Collect</h2>
              ...
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">How We Use Your Information</h2>
              <p className="text-beige mb-4">
              ...
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">Payment Processing</h2>
              <p className="text-beige mb-4">
              ...
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">Cookies &amp; Local Storage</h2>
              <p className="text-beige mb-4">
              ...
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">Website Analytics &amp; Session Replay</h2>
              <p className="text-beige mb-4">
              ...
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">Your Rights</h2>
              <p className="text-beige mb-4">
              ...
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">Data Security</h2>
              <p className="text-beige mb-4">
              ...
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">Changes to This Policy</h2>
              <p className="text-beige mb-4">
        ...
        <section className="py-16 sm:py-20 border-t border-line bg-offwhite">
          <Container>
            <div className="text-center max-w-2xl mx-auto">
              <h2 className="font-sans font-bold tracking-tight text-3xl sm:text-4xl mb-6 text-cream">Questions?</h2>
