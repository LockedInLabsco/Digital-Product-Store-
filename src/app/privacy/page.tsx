        ...
        <section className="py-12 sm:py-16">
          <Container>
            ...
            <div className="max-w-3xl">
              <h1 className="font-serif text-5xl sm:text-6xl mb-4 leading-tight text-ink">Privacy Policy</h1>
        ...
        <section className="py-16 sm:py-20 border-t border-ink/10">
          <Container>
            <div className="max-w-3xl prose prose-sm">
              <h2 className="font-serif text-2xl mb-4 mt-8 text-ink">What Information We Collect</h2>
              ...
              <h2 className="font-serif text-2xl mb-4 mt-8 text-ink">How We Use Your Information</h2>
              <p className="text-ink/65 mb-4">
              ...
              <h2 className="font-serif text-2xl mb-4 mt-8 text-ink">Payment Processing</h2>
              <p className="text-ink/65 mb-4">
              ...
              <h2 className="font-serif text-2xl mb-4 mt-8 text-ink">Cookies</h2>
              <p className="text-ink/65 mb-4">
                Our website uses basic cookies to improve your experience. These are minimal and do not track personal information.
              </p>

              <h2 className="font-serif text-2xl mb-4 mt-8 text-ink">Your Rights</h2>
              <p className="text-ink/65 mb-4">
              ...
              <p className="text-ink/65 mb-4">
                To exercise these rights, contact us at <a href="mailto:hello@not4normal.store" className="text-ink underline hover:no-underline">hello@not4normal.store</a>.
              </p>

              <h2 className="font-serif text-2xl mb-4 mt-8 text-ink">Data Security</h2>
              <p className="text-ink/65 mb-4">
              ...
              <h2 className="font-serif text-2xl mb-4 mt-8 text-ink">Changes to This Policy</h2>
              <p className="text-ink/65 mb-4">
              ...
              <p className="text-ink/65 mb-4">
                If you have questions about this privacy policy or how we handle your information, please contact us at <a href="mailto:hello@not4normal.store" className="text-ink underline hover:no-underline">hello@not4normal.store</a>.
              </p>
            </div>
          </Container>
        </section>
