        ...
        <section className="py-12 sm:py-16">
          <Container>
            ...
            <div className="max-w-3xl">
              <h1 className="font-sans font-bold tracking-tight text-5xl sm:text-6xl mb-4 leading-tight text-cream">Terms of Service</h1>
        ...
        <section className="py-16 sm:py-20 border-t border-line">
          <Container>
            <div className="max-w-3xl legal-copy">
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">1. What We Sell</h2>
              ...
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">2. How You Get Your Products</h2>
              <p className="text-beige mb-4">
              ...
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">3. Payment</h2>
              <p className="text-beige mb-4">
              ...
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">4. Use of Products</h2>
              <p className="text-beige mb-4">
              ...
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">5. No Refunds</h2>
              <p className="text-beige mb-4">
              ...
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">6. Limitations</h2>
              <p className="text-beige mb-4">
              ...
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">7. Changes to Terms</h2>
              <p className="text-beige mb-4">
              ...
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">8. Contact Us</h2>
              <p className="text-beige mb-4">
