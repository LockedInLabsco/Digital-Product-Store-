      ...
      <main className="bg-ink">
        <section className="py-12 sm:py-16">
          <Container>
            <Link
              href="/"
              className="text-beige hover:text-gold mb-6 sm:mb-8 inline-block text-sm"
            >
              ← Back Home
            </Link>
            <div className="max-w-3xl">
              <h1 className="font-sans font-bold tracking-tight text-5xl sm:text-6xl mb-4 leading-tight text-cream">Refund Policy</h1>
              <p className="text-beige text-lg mb-8">Last updated: July 2026</p>
            </div>
          </Container>
        </section>
        ...
        <section className="py-16 sm:py-20 border-t border-line">
          <Container>
            <div className="max-w-3xl legal-copy">
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">Digital Products Are Non-Refundable</h2>
              ...
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">Exceptions to Our Refund Policy</h2>
              <p className="text-beige mb-4">
                We will consider refund requests in the following situations:
              </p>

              <h3 className="font-sans font-bold tracking-tight text-xl mb-3 mt-6 text-cream">1. Technical Issues</h3>
              <p className="text-beige mb-4">
              ...
              <h3 className="font-sans font-bold tracking-tight text-xl mb-3 mt-6 text-cream">2. Duplicate Purchases</h3>
              <p className="text-beige mb-4">
                If you were accidentally charged twice for the same product, we will refund the duplicate charge.
              </p>

              <h3 className="font-sans font-bold tracking-tight text-xl mb-3 mt-6 text-cream">3. Unauthorized Charges</h3>
              <p className="text-beige mb-4">
                If you believe a charge was made without your authorization, please contact us immediately.
              </p>

              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">How to Request a Refund</h2>
              <p className="text-beige mb-4">
              ...
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">Response Time</h2>
              <p className="text-beige mb-4">
              ...
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">What About Money-Back Guarantees?</h2>
              <p className="text-beige mb-4">
              ...
              <h2 className="font-sans font-bold tracking-tight text-2xl mb-4 mt-8 text-cream">Contact Us</h2>
              <p className="text-beige mb-4">
        ...
        <section className="py-16 sm:py-20 border-t border-line bg-offwhite">
          <Container>
            <div className="text-center max-w-2xl mx-auto">
              <h2 className="font-sans font-bold tracking-tight text-3xl sm:text-4xl mb-6 text-cream">Need Help?</h2>
