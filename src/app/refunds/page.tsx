        ...
        <section className="py-12 sm:py-16">
          <Container>
            ...
            <div className="max-w-3xl">
              <h1 className="font-serif text-5xl sm:text-6xl mb-4 leading-tight text-ink">Refund Policy</h1>
        ...
        <section className="py-16 sm:py-20 border-t border-ink/10">
          <Container>
            <div className="max-w-3xl prose prose-sm">
              <h2 className="font-serif text-2xl mb-4 mt-8 text-ink">Digital Products Are Non-Refundable</h2>
              ...
              <h2 className="font-serif text-2xl mb-4 mt-8 text-ink">Exceptions to Our Refund Policy</h2>
              <p className="text-ink/65 mb-4">
                We will consider refund requests in the following situations:
              </p>

              <h3 className="font-serif text-xl mb-3 mt-6 text-ink">1. Technical Issues</h3>
              <p className="text-ink/65 mb-4">
              ...
              <h3 className="font-serif text-xl mb-3 mt-6 text-ink">2. Duplicate Purchases</h3>
              <p className="text-ink/65 mb-4">
                If you were accidentally charged twice for the same product, we will refund the duplicate charge.
              </p>

              <h3 className="font-serif text-xl mb-3 mt-6 text-ink">3. Unauthorized Charges</h3>
              <p className="text-ink/65 mb-4">
                If you believe a charge was made without your authorization, please contact us immediately.
              </p>

              <h2 className="font-serif text-2xl mb-4 mt-8 text-ink">How to Request a Refund</h2>
              <p className="text-ink/65 mb-4">
                To request a refund, email us at <a href="mailto:hello@not4normal.store" className="text-ink underline hover:no-underline">hello@not4normal.store</a> with:
              </p>
              ...
              <h2 className="font-serif text-2xl mb-4 mt-8 text-ink">Response Time</h2>
              <p className="text-ink/65 mb-4">
              ...
              <h2 className="font-serif text-2xl mb-4 mt-8 text-ink">What About Money-Back Guarantees?</h2>
              <p className="text-ink/65 mb-4">
              ...
              <h2 className="font-serif text-2xl mb-4 mt-8 text-ink">Contact Us</h2>
              <p className="text-ink/65 mb-4">
                If you have questions about our refund policy or want to request a refund, please contact us at <a href="mailto:hello@not4normal.store" className="text-ink underline hover:no-underline">hello@not4normal.store</a>.
              </p>
            </div>
          </Container>
        </section>
        ...
        <section className="py-16 sm:py-20 border-t border-ink/10 bg-offwhite">
          <Container>
            <div className="text-center max-w-2xl mx-auto">
              <h2 className="font-serif text-3xl sm:text-4xl mb-6 text-ink">Need Help?</h2>
