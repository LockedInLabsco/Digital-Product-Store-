  ...
  return (
    ...
    >
      <div className="mx-auto flex h-[68px] max-w-5xl items-center justify-between px-6 sm:px-8">
        ...
        <a
          href="#join"
          className="inline-flex items-center justify-center rounded-full px-4 py-2 text-xs font-semibold uppercase tracking-[0.1em] transition-opacity hover:opacity-85 sm:px-5 sm:py-2.5"
